...
```mermaid
graph LR
    A[Excel Source<br/>119K Records] --> B[Power Query]
    B --> C{Data Cleaning}
    C --> D[Remove Nulls]
    C --> E[Type Conversion]
    C --> F[Date Standardization]
    D --> G[Data Model]
    E --> G
    F --> G
    G --> H[DAX Calculations]
    H --> I[Visualizations]
...
![Cancellation Trends](screenshots/cancellation_trends.png)

### Market Segment Breakdown
![Market Segments](screenshots/market_segment_analysis.png)

### Geographic Distribution
![Geographic Analysis](screenshots/geographic_distribution.png)
...
[![GitHub stars](https://img.shields.io/github/stars/yourusername/hotel-booking-demand-analysis?style=social)](https://github.com/yourusername/hotel-booking-demand-analysis/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/yourusername/hotel-booking-demand-analysis?style=social)](https://github.com/yourusername/hotel-booking-demand-analysis/network/members)
[![GitHub watchers](https://img.shields.io/github/watchers/yourusername/hotel-booking-demand-analysis?style=social)](https://github.com/yourusername/hotel-booking-demand-analysis/watchers)
